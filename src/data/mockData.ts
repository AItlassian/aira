...
export const pullRequests: PullRequest[] = [
  {
    ...
    repo: 'ai-code-commander',
    branch: 'main',
    changedFiles: [
      { path: 'src/services/auth.ts', additions: 10, deletions: 0 },
      { path: 'src/components/Login.tsx', additions: 20, deletions: 0 }
    ],
    relatedTickets: ['t1'],
    relatedDocs: ['d1']
  },
  {
    id: 'pr2',
    title: 'Fix Navigation State Management',
    description: 'Fix state inconsistencies in navigation system',
    author: 'Jane Smith',
    createdAt: '2025-04-29T10:00:00Z',
    status: 'merged',
    commits: [{
      id: 'c2',
      message: 'Fix navigation state management',
      author: 'Jane Smith',
    ...
    branch: 'main',
    changedFiles: [
      { path: 'src/components/Navigation.tsx', additions: 0, deletions: 0 }
    ],
    relatedTickets: ['t2'],
    relatedDocs: []
  }
